...
export const PROJECTS: Project[] = [
  { id: 1, title: 'E-commerce Automation', category: 'Automation', industry: 'Retail', metric: '50% time saved', image: 'https://picsum.photos/seed/p1/600/400' },
  { id: 2, title: 'SaaS Landing Page', category: 'Web Dev', industry: 'Tech Startup', metric: '3x conversions', image: 'https://picsum.photos/seed/p2/600/400' },
  { id: 3, title: 'CRM Integration', category: 'CRM', industry: 'Agency', metric: 'Zero lost leads', image: 'https://picsum.photos/seed/p3/600/400' },
  { id: 4, title: 'SEO Overhaul', category: 'SEO', industry: 'Local Business', metric: '+140% traffic', image: 'https://picsum.photos/seed/p4/600/400' },
  { id: 5, title: 'Multi-platform Automation', category: 'Automation', industry: 'Consulting', metric: '15h saved/week', image: 'https://picsum.photos/seed/p5/600/400' },
  { id: 6, title: 'Custom Portal', category: 'Web Dev', industry: 'Healthcare', metric: '40% faster ops', image: 'https://picsum.photos/seed/p6/600/400' }
];

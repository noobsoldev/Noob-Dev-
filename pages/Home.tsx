  ...
  code: false
      ...
      <section className="py-10 border-y border-gray-100 bg-gray-50">
        <div className="max-w-7xl mx-auto px-6">
          <p className="text-center text-xs font-mono text-gray-400 mb-8 uppercase tracking-widest">Integrating your favorite tools</p>
          <div className="flex flex-wrap justify-center gap-8 md:gap-16 opacity-50 grayscale hover:grayscale-0 transition-all">
            {['Zapier', 'Make', 'Airtable', 'HubSpot', 'Slack', 'Notion'].map(tool => (
              <div key={tool} className="text-xl font-bold font-mono text-gray-900">{tool}</div>
            ))}
          </div>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {[
              ...
              { name: 'Elena Rodriguez', role: 'Director, MediaForge', text: "Cleanest integration we've ever seen. No more manual data entry between our CRM and Slack." },
            ].map((t, idx) => (
